...
cowplot::plot_grid(pfreqs,plot_grid(plen,pwid,pht,pdep,prwid,pses, align = 'hv', labels = 'auto'))
```
...
The model performe quite poorly, there is significant VIF, probably due to the low number of logs. Let's reduce the number of variables.
